    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Image.asset(
              'assets/images/ก๋วยเตี๋ยว.png', // เปลี่ยน path ให้ตรงกับรูปของคุณ
              width: 200,
              height: 200,
            ),
              ...
              children: const [
                ...
                TableRow(
                  children: [
                    Padding(
                      padding: EdgeInsets.all(8.0),
                      child: Text('ก๋วยเตี๋ยว'),
                    ),
                    Padding(
                      padding: EdgeInsets.all(8.0),
                      child: Text('400 เเคลอรี่'),
                    ),
                  ],
                ),
                TableRow(
